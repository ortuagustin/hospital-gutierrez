...
class CreateMedicalRecordsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('medical_records', function (Blueprint $table) {
            ...
            $table->text('alimentacion_observaciones', 255);
            $table->boolean('vacunas_completas');
            $table->text('vacunas_observaciones', 255);
            $table->boolean('maduracion_acorde');
            $table->text('maduracion_observaciones', 255);
            $table->boolean('examen_fisico_normal');
            $table->text('examen_fisico_observaciones', 255);
