...
class CreateMedicalRecordsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('medical_records', function (Blueprint $table) {
            ...
            $table->varchar('alimentacion_observaciones', 255);
            $table->boolean('vacunas_completas');
            $table->varchar('vacunas_observaciones', 255);
            $table->boolean('maduracion_acorde');
            $table->varchar('maduracion_observaciones', 255);
            $table->boolean('examen_fisico_normal');
            $table->varchar('examen_fisico_observaciones', 255);
            $table->varchar('observaciones', 255);
