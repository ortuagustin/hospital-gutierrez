...
class DefaultApplicationSettings implements DefaultApplicationSettingsInterface
{
    ...
    public function resetToDefault()
    {
        ...
        ApplicationSetting::put('title', config('APP_TITLE', $this->defaults['title']), 'text', true);
        ApplicationSetting::put('description', config('APP_DESCRIPTION', $this->defaults['description']), 'text', true);
