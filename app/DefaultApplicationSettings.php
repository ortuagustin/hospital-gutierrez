...
class DefaultApplicationSettings implements DefaultApplicationSettingsInterface
{
    ...
    public function resetToDefault()
    {
        ...
        ApplicationSetting::put('contact_email', config('APP_CONTACT_EMAIL', $this->defaults['contact_email']));
        ApplicationSetting::put('records_per_page', config('APP_RECORDS_PER_PAGE', $this->defaults['records_per_page']));
        ApplicationSetting::put('maintenance', 'false');
    }
}
